  ...
  return (
    <>
      <h1 className="text-2xl text-zinc-500 mb-5">
        Store <span className="text-zinc-800 font-medium">Orders</span>
      </h1>
      {orders.length === 0 ? (
        <p>No orders found</p>
      ) : (
          ...
          <table className="w-full text-sm text-left text-gray-600">
            ...
            <tbody className="divide-y divide-gray-100">
              {orders.map((order, index) => (
                ...
                >
                  <td className="pl-6 text-[#FF802C]">{index + 1}</td>
      ...
      {isModalOpen && selectedOrder && (
        <div
          onClick={closeModal}
          className="fixed inset-0 flex items-center justify-center bg-black/50 text-zinc-700 text-sm backdrop-blur-xs z-50"
        >
          <div
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                {selectedOrder.orderItems.map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-4 border border-zinc-100 shadow rounded p-2"
                  >
                    <img
                      src={
                    ...
                    <div className="flex-1">
                      <p className="text-zinc-800">{item.product?.name}</p>
