  ...
  return (
    <footer className="mx-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-zinc-500/30 text-zinc-500">
          <div>
            <Link href="/" className="text-4xl font-semibold text-zinc-700">
            ...
            <p className="max-w-[410px] mt-6 text-sm">
              Welcome to gizmocart, your ultimate destination for the latest and
            ...
            <div className="flex items-center gap-3 mt-5">
              {socialIcons.map((item, i) => (
                <Link
                  href={item.link}
                  key={i}
                  className="flex items-center justify-center w-10 h-10 bg-zinc-100 hover:scale-105 hover:border border-zinc-300 transition rounded-full"
                >
                  <item.icon />
                </Link>
              ))}
          ...
          <div className="flex flex-wrap justify-between w-full md:w-[45%] gap-5 text-sm ">
            {linkSections.map((section, index) => (
              <div key={index}>
                <h3 className="font-medium text-zinc-700 md:mb-5 mb-3">
                  {section.title}
                </h3>
        ...
        <p className="py-4 text-sm text-zinc-500">
          Copyright 2025 © gizmocart All Right Reserved.
        </p>
      </div>
    </footer>
  );
