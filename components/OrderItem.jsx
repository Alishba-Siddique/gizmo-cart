...
const OrderItem = ({ order }) => {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-6">
            {order.orderItems.map((item, index) => (
              <div key={index} className="flex items-center gap-4">
                <div className="w-20 aspect-square bg-zinc-100 flex items-center justify-center rounded-md">
                  <Image
                ...
                <div className="flex flex-col justify-center text-sm">
                  <p className="font-medium text-zinc-600 text-base">
                    {item.product.name}
                  </p>
                  <p>
                    {currency}
                  ...
                  <div>
                    {ratings.find(
                      ...
                      <button
                        ...
                        className={`text-[#FF802C] hover:bg-green-50 transition ${
      ...
      <tr>
        <td colSpan={4}>
          <div className="border-b border-zinc-300 w-6/7 mx-auto" />
        </td>
      </tr>
    </>
  );
